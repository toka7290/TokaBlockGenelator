<template id="value-elements-component">
                      ...
                      <div class="value-input type-array-select">
                        <div class="array-list">
                          <label class="array-data">
                            <div class="array-num">0</div>
                            <select
                              name="components-placement-filter-allowed-faces"
                              class="components-placement-filter-allowed-faces type-array-select"
                            >
                        ...
                        <div class="array-list">
                          <label class="array-data">
                            ...
                            <input
                              ...
                              class="components-placement-filter-block-filter type-array-string"
                            />
                          </label>
                        </div>
                        <div class="array-list-control">
  ...
  >
    <label class="value-checkbox">
      <input
        type="checkbox"
        name="components-preventsJumping"
        class="components-preventsJumping invisible-Control"
      />
  ...
  <div
    ...
    title="このブロックの地図での色を設定します。#000000~#ffffffまで設定できます。"
  >
    <div class="value-label">
      <p>地図の色</p>
    </div>
  ...
  >
    ...
    <label class="value-input">
      <input
        ...
        min="0"
        max="16"
        name="components-block-light-absorption"
        class="components-block-light-absorption"
        value="0"
      />
    </label>
  </div>
    ...
    <div class="value-input type-unit">
      <label>
        <input
          ...
          min="0.0"
          max="1.0"
          name="components-block-light-emission"
          class="components-block-light-emission"
          value="0.0"
          step="0.1"
        />
  ...
  >
    ...
    <label class="value-input">
      <input
        type="number"
        min="0"
        name="components-explosion-resistance"
        class="components-explosion-resistance"
        value="1.0"
        step="0.1"
      />
    </label>
  ...
  >
    <label class="value-checkbox">
      <input
        type="checkbox"
        name="components-onlypistonpush"
        class="components-onlypistonpush invisible-Control"
      />
      <div class="checkbox-body">
        <div class="checkbox-body-box">
          <svg
            ...
            <div class="modal-body">
              ...
              >
                ...
                <label class="value-input">
                  <input
                    type="text"
                    name="components-event-on-fall-on-event"
                    class="components-event-on-fall-on-event"
              ...
              >
                ...
                <label class="value-input">
                  <input
                    type="text"
                    name="components-event-on-fall-on-condition"
                    class="components-event-on-fall-on-condition"
                  />
                </label>
              </div>
              <div
              ...
              >
                ...
                <div class="value-input">
                  <select
                    name="components-event-on-fall-on-target"
                    class="components-event-on-fall-on-target"
                  >
            ...
            <div class="modal-body">
              ...
              >
                ...
                <label class="value-input">
                  <input
                    type="text"
                    name="components-event-on-interact-event"
                    class="components-event-on-interact-event"
                    list="event-name-list"
                  />
                </label>
              </div>
              ...
              >
                ...
                <label class="value-input">
                  <input
                    type="text"
                    name="components-event-on-interact-condition"
                    class="components-event-on-interact-condition"
                  />
                </label>
              </div>
              <div
              ...
              >
                ...
                <div class="value-input">
                  <select
                    name="components-event-on-interact-target"
                    class="components-event-on-interact-target"
                  >
                    <option value="default">default</option>
                    <option value="self">self</option>
                    <option value="holder">holder</option>
            ...
            <div class="modal-body">
              ...
              >
                ...
                <label class="value-input">
                  <input
                    type="text"
                    name="components-event-on-placed-event"
                    class="components-event-on-placed-event"
                    list="event-name-list"
                  />
                </label>
              </div>
              ...
              >
                ...
                <label class="value-input">
                  <input
                    type="text"
                    name="components-event-on-placed-condition"
                    class="components-event-on-placed-condition"
                  />
                </label>
              </div>
              <div
              ...
              >
                ...
                <div class="value-input">
                  <select
                    name="components-event-on-placed-target"
                    class="components-event-on-placed-target"
                  >
                    <option value="default">default</option>
                    <option value="self">self</option>
                    <option value="holder">holder</option>
  ...
  <div
    ...
    title="エンティティがブロックを歩き始めた時のイベントを定義します。"
  >
    <div class="value-label">
      <p>トリガ(踏んだ時)</p>
    </div>
            ...
            <div class="modal-body">
              ...
              >
                ...
                <label class="value-input">
                  <input
                    type="text"
                    name="components-event-on-step-on-event"
                    class="components-event-on-step-on-event"
                    list="event-name-list"
                  />
                </label>
              </div>
              ...
              >
                ...
                <label class="value-input">
                  <input
                    type="text"
                    name="components-event-on-step-on-condition"
                    class="components-event-on-step-on-condition"
                  />
                </label>
              </div>
              <div
              ...
              >
                ...
                <div class="value-input">
                  <select
                    name="components-event-on-step-on-target"
                    class="components-event-on-step-on-target"
                  >
                    <option value="default">default</option>
                    <option value="self">self</option>
                    <option value="holder">holder</option>
            ...
            <div class="modal-body">
              ...
              >
                ...
                <label class="value-input">
                  <input
                    type="text"
                    name="components-event-on-step-off-event"
                    class="components-event-on-step-off-event"
                    list="event-name-list"
                  />
                </label>
              </div>
              ...
              >
                ...
                <label class="value-input">
                  <input
                    type="text"
                    name="components-event-on-step-off-condition"
                    class="components-event-on-step-off-condition"
                  />
                </label>
              </div>
              <div
              ...
              >
                ...
                <div class="value-input">
                  <select
                    name="components-event-on-step-off-target"
                    class="components-event-on-step-off-target"
                  >
                    <option value="default">default</option>
                    <option value="self">self</option>
                    <option value="holder">holder</option>
            ...
            <div class="modal-body">
              ...
              >
                ...
                <label class="value-input">
                  <input
                    type="text"
                    name="components-event-on-player-destroyed-event"
                    class="components-event-on-player-destroyed-event"
                    list="event-name-list"
                  />
                </label>
              </div>
              ...
              >
                ...
                <label class="value-input">
                  <input
                    type="text"
                    name="components-event-on-player-destroyed-condition"
                    class="components-event-on-player-destroyed-condition"
                  />
                </label>
              </div>
              <div
              ...
              >
                ...
                <div class="value-input">
                  <select
                    name="components-event-on-player-destroyed-target"
                    class="components-event-on-player-destroyed-target"
                  >
                    <option value="default">default</option>
                    <option value="self">self</option>
                    <option value="holder">holder</option>
                    ...
                    >
                      ...
                      <label class="value-input">
                        <input
                          type="number"
                          min="0"
                          name="event-responses-randomize-weight"
